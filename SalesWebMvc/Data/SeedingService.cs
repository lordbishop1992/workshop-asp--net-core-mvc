...
{
    //essa class serve para ENVIAR DADOS PARA O BANCO, porem deve chama-la(o método Seed) lá na class STARTUP.cs
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2001, 1, 9), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexpink@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);
            ...
            //comando para salvar os objetos criados acima dentro do banco de dados
